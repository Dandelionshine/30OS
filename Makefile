...
haribote.img : haribote/ipl09.bin haribote/haribote.sys Makefile \
		...
		lines/lines.hrb walk/walk.hrb noodle/noodle.hrb notepad/notepad.hrb \
		beepdown/beepdown.hrb color/color.hrb color2/color2.hrb \
		sosu/sosu.hrb sosu2/sosu2.hrb sosu3/sosu3.hrb \
		type/type.hrb info/info.hrb iroha/iroha.hrb chklang/chklang.hrb \
	...
	$(EDIMG)   imgin:../z_tools/fdimg0at.tek \
		...
		copy from:mmlGame/mmlGame.hrb to:@: \
		...
		copy from:pictdata/image.jpg to:@: \
		imgout:haribote.img

#		copy from:pictdata/image1.jpg to:@: \
